...
const latestUpdates = [
  {
    ...
    description: "Discover 3 new creative variants including Suika Unblocked and celebrity-themed versions.",
    category: "New Games",
  ...
  },
  {
    ...
    description: "Enhanced touch controls and faster loading times for mobile devices across all game variants.",
    category: "Updates",
    link: "/",
  },
  {
    ...
    description: "Master advanced techniques with our comprehensive strategy guide for achieving high scores.",
    category: "Guides",
    link: "/howtowin",
  },
  {
    ...
    description: "Play Suika Game in 6 different languages with localized content and instructions.",
    category: "Features",
